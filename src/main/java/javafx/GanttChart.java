...
/**
 * This class is used to establish the chart that displays a single schedule
 * This chart was built based on a XY chart, where X axis is time and Y axis is processor
 */
public class GanttChart<X, Y> extends XYChart<X, Y> {
    ...
    public static class ExtraData {
        ...
        public ExtraData(int lengthMs, String styleClass, String taskName) {
            super();
