...
> An example folder has been included to play around with, feel free to run the dot files in the examples folder!
...
```cmd
java -jar scheduler-win.jar examples/g11/in.dot 2 -v
```

**Linux:**

```cmd
java -jar scheduler.jar examples/g11/in.dot 2 -v
```
